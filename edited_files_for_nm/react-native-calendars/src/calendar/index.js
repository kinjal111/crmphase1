...
class Calendar extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      year: props.current ? parseDate(props.current) : XDate(),
...
// sssconsole.warn('Node Modules : ' , day.toString('yyyy-MM-dd'))
  ...
  render() {
    ...
    const days = dateutils.page(this.state.currentMonth, this.props.showSixWeeks, this.props.firstDay,  this.props.hideExtraDays);
