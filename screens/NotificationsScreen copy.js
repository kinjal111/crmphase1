    ...
    return (
      ...
      <View style={styles.container}>
        ...
        <SafeAreaView>
            ...
            <View style={{ flexDirection: 'row', marginBottom: 2 }}>
              ...
              <TouchableOpacity onPress={() => { this.fetch_New_Notification() }}>
                ...
                <View style={[styles.new_notification]}>
                  ...
                  <Text style={[styles.newnotficationtext]}>New Notification</Text>

                </View>

              </TouchableOpacity>

              <TouchableOpacity onPress={() => { this.toggle_Display_Other_Notification() }} >
          ...
          <SwipeListView style={{ marginTop: 1, marginBottom: 95, }}
            useFlatList={true}
