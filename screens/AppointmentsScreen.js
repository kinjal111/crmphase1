...
export default class AppointmentsScreen extends React.Component {
  ...
  static navigationOptions = ({ navigation }) => {
    ...
    return {
      ...
      headerTitle: () => <Text style={textHeader.header}>
        {
          params.isEdit == true ?
            Constant.edit_appointment
            :
            Constant.schedule_appointment
        }
      </Text>,
  ...
  componentDidMount = async () => {
    ...
    if (isConnected) {
      ...
      if (PreviousScreen === 'Detail') {
        ...
        if (navigation.getParam('isEdit') == true)
        ...
        if (this.state.isPage == true) {
          ...
          console.warn("AppointmentData Reminder.....", AppointmentData.appt_reminder,"t");
          ...
          if(AppointmentData.appt_reminder=="t"){
            console.warn("Appoint Reminder",AppointmentData.appt_reminder);
          }
          else{
            this.setState({defaultReminder:AppointmentData.appt_reminder});
            this.setState({AppointmentReminderBool:true});
          }
          ...
          console.warn("Select Conversation...", this.state.select_conversation);
          ...
          this.setState({ SelectedContactCompanyName: navigation.getParam('contact_company_name') });
          this.setState({ renderSelectedItemState: true });
          console.warn("ContactCompany NAme Edit..", this.state.SelectedContactCompanyName);
          ...
          // this.setState({postalcode:AppointmentData.postale});
          this.setState({ count: this.state.count + 1 });
        }
        else {
          this.setState({ contact_id: navigation.getParam('contactID'), company_id: navigation.getParam('companyID') }, () => { this.getCompanyData(), this.fetchAppointmentInitilaData(), this.getContactData() });
          this.setState({ SelectedContactCompanyName: navigation.getParam('contact_company_name') });
          this.setState({ renderSelectedItemState: true });
          console.warn("ContactCompany NAme..", this.state.SelectedContactCompanyName);
      ...
      if (PreviousScreen === 'Prospects') {
        ...
        this.setState({ day: calendarDate.date(), contact_id: navigation.getParam('contactID'), company_id: navigation.getParam('companyID') }, () => { this.getContactData(), this.fetchAppointmentInitilaData(), this.getCompanyData() })
        ...
        .then(responseJson => {
          ...
          if (str.error == 101) {
            ...
            this.setState({ isLoading: false, AppointmentTime: str.default_data.appointment_time, conversation: str.conversation_list, meetingType: str.meeting_types, CompanyOffice: str.company_offices, MeetAgentData: str.meet_agents, ClientOffice: str.client_office, AppointmentReminder: str.default_data.default_appt_reminder_to_customer, defaultAppointmentReminder: str.default_data.def_reminder }, () => {
              console.warn("Meet Agent Data ...", this.state.MeetAgentData);
              if (this.state.isPage == true) {
                this.setState({ AppointmentTime: this.state.AppointmentData.appointment_time });
                let str = this.state.AppointmentData.appt_meet_agent;
                console.warn("Array", str);
                let arr = str.split(",");
                console.warn("array..", arr);
                let arr2 = this.state.MeetAgentData;
                console.warn("Array2", arr2);
                let arr3 = [];
                for (let i = 0; i < arr2.length; i++) {
                  for (let j = 0; j < arr.length; j++) {
                    if (arr2[i].id == arr[j]) {
                      console.warn("Arr[i]", arr2[i]);
                      arr3[j] = arr2[i].name;
                ...
                console.warn("Array3", arr3);
                this.setState({ SelectedMeetAgent: arr3 });
                this.state.SelectedMeetAgent.push(arr3);
                console.warn("Select123", this.state.SelectedMeetAgent);
              }
              ...
              if (this.state.SelectedMeetAgent.length === 0) {
                ...
                console.warn("Select Agent Curretn",this.state.SelectedMeetAgent);
  ...
  searchContact = async (Search) => {
    ...
    if (isConnected) {
      ...
      console.warn("FormData Search....", formData);
  ...
  modifyContactandCompanyData() {
    ...
    if (this.state.ContactandCompanyData === undefined || this.state.ContactandCompanyData === [] || this.state.ContactandCompanyData.length === 0 || this.state.search === '') {
      ...
      console.warn("Item End...", this.state.ContactandCompanyData);
    ...
    return (
      ...
      <View style={styles.search, { width: '100%', height: 46, flexDirection: 'row', }} >
        ...
        <TextInput
          ...
          value={this.state.SelectedContactCompanyName}
      ...
      .then(responseJson => {
        ...
        if (str.error === 101) {
          ...
          if (this.state.isPage == true) {
            ...
            this.setState({ Address: str.address, postalcode: str.postal_code });
          }
          this.forceUpdate();
          console.warn("Adrress ...", this.state.Address);
          console.warn("Postal Code...", this.state.postalcode);
  ...
  // onCreateAppointment(){
  //   if(this.state.isSave==1){
  //     this.createAppointment();
  //   }
  //   else{
  //     console.warn("Button Click 2 Times...");
  //   }
  ...
  createAppointment = async () => {
    ...
    // const { navigation } = this.props;
    // const itemId = navigation.getParam('isEdit', {}); 
    const api_token = await AsyncStorage.getItem(Constant.api_token);
    let formData = new FormData();
    ...
    console.warn("Slecting Agenr...",this.state.SelectedMeetAgent);
    ...
    console.warn("Slected ..",selectedMeetAgentsToItems);
    // selectedMeetAgentsToItems = "317";
    // if(this.state.isPage==true){

    
    // let str = selectedMeetAgentsToItems;
    // console.warn("Array", str);
    // let arr5 = str.split(",");
    // console.warn("array..", arr5);
    // let arr6 = this.state.MeetAgentData;
    // console.warn("Array2", arr6);
    // let arr7 = [];
    // for (let i = 0; i < arr6.length; i++) {
    //   for (let j = 0; j < arr5.length; j++) {
    //     if (arr6[i].name == arr5[j]) {
    //       console.warn("Arr[i]", arr6[i]);
    //       arr7[j] = arr6[i].id;
    //     }
    //   }
    // }
    // console.warn("Array3", arr7);
    // this.setState({ SelectedMeetAgent: arr7 });
    // this.state.SelectedMeetAgent.push(arr7);
    // let arr8=this.state.SelectedMeetAgent;
    // console.warn("Array 8",arr8);
    // // selectedMeetAgentsToItems=this.state.SelectedMeetAgent;
    // console.warn("Select123 Edit..", this.state.SelectedMeetAgent);
    // }
    let arr = this.state.conversation;
      console.warn("Con", this.state.conversation);
      console.warn("arr", arr.length);
      console.warn("Select Conver Current..",this.state.select_conversation);
      let val = "";
      for (let i = 0; i < arr.length; i++) {

        if (arr[i].label == this.state.select_conversation) {
          console.warn("arr[i]", arr[i]);
          val = arr[i].label;
          console.warn("value1", arr[i].value);
          this.setState({ select_conversation: arr[i].value });
         
          break;
        }
      }
      let arr1 = this.state.MeetingPlaceData;
      for (let i = 0; i < arr1.length; i++) {
        if (arr1[i].label == this.state.selectMeetingPlace) {
          this.setState({ selectMeetingPlace: arr1[i].value });

        }
      }
      console.warn("SEleCt Meeting Of Place Save", this.state.selectMeetingPlace)
      let arr2= this.state.CompanyOffice;
      for (let i = 0; i < arr2.length; i++) {
        if (arr2[i].office_name == this.state.select_CompanyOffice) {
          console.warn("Arr[i] Office", arr2[i].id);
          this.setState({ select_CompanyOffice: arr2[i].id }, () => console.warn("Select Meeting Place 1234", this.state.select_CompanyOffice));
    ...
    if (this.state.note === '' || this.state.select_conversation === '' || this.state.dateFrom === '' || selectedMeetAgentsToItems === '' || this.state.AppointmentTime === '' || this.state.endTime === '' || this.state.Address === '' || this.state.postalcode === '' ) {
     console.log('contact_id',this.state.contact_id)
      showMessage({
        message: "",
        description: "One of the fields is required",
        type: "danger",
      });
      if(this.state.SelectedContactCompanyName.length === 0 && this.state.isSaveClicked && this.state.contact_id === ''){
      ...
      console.log("IS SAVE BTN out..", this.state.isSave);
      ...
      const isConnected = await NetworkUtils.isNetworkAvailable()
       if (this.state.isSave == false ) {
        ...
        // let conver=9758;
        // this.setState({select_conversation:conver});
        console.warn("arrr... Conversation ", this.state.select_conversation);
        if (isConnected) {
          ...
          formData.append('meet_agent', SelectedMeetAgentItems);//317
          formData.append('meeting_type', this.state.select_meetingType);
          formData.append('end_time', this.state.endTime);
          formData.append('address', this.state.Address);
          formData.append('postal_code', this.state.postalcode);
          if(this.state.AppointmentReminderBool==true){
            formData.append('reminder', this.state.defaultReminder);    
          }
          else{
            let isValue="t";
            this.setState({defaultReminder:isValue});
            formData.append('reminder', this.state.defaultReminder);
          }
        
          formData.append('meeting_place', this.state.selectMeetingPlace);

          if (this.state.selectMeetingPlace === 1) {
            formData.append('meeting_office_place', this.state.select_CompanyOffice);
          }
          console.log("Meeting Office Place...", this.state.select_CompanyOffice);
          var dt = (moment(momentObj).format('YYYY-MM-DD')).toString();
          ...
          fetch(apiBasePath, {
            ...
            .then(responseJson => {
              ...
              if (str.error === 101) {
                ...
                if (str.status === 200) {
                  console.log("String12345 ...", str);
                  console.log(' Date Formate appontment screen : ', this.state.dateFrom)

                  console.log("Is Save", this.state.isSave);
                  showMessage({
                    message: "",
                    ...
                    this.props.navigation.navigate('Calendar', { Apptdate: dt })
  ...
  modifyKeyforDropDown = async () => {
    ...
    if (CompanyOfficeItem === null || CompanyOfficeItem === undefined) {
      ...
      console.warn("############################ : ", CompanyOfficeItem);
    ...
    MeetingType.unshift({ label: "Select Meeting Type", value: "Select Meeting Type" })
    ...
    if (this.state.isPage == true) {
      //       var item = this.state.AppointmentData.meeting_type;
      //       item.unshift({label:'Select Meeting Type',value:'Select Meeting Type'});
      // console.warn('item : ' , item);
      this.setState({ select_meetingType: this.state.AppointmentData.meeting_type });
      // this.setState({ select_meetingType: item });
      // this.setState({ selectMeetingPlace: this.state.AppointmentData.meta.appt_meeting_place });
      let arr = this.state.MeetingPlaceData;
      console.warn("Meeting Place Data...",this.state.MeetingPlaceData);
      for (let i = 0; i < arr.length; i++) {
      ...
      console.warn("SEleCt Meeting Of Place", this.state.selectMeetingPlace)
      let arr1 = this.state.CompanyOffice;
      console.warn("Atta1",arr1);
      for (let i = 0; i < arr1.length; i++) {
        if (arr1[i].id == this.state.AppointmentData.meta.appt_meeting_office_place) {
          console.warn("Arr[i] Office", arr1[i].office_name);
          this.setState({ select_CompanyOffice: arr1[i].office_name }, () => console.warn("Select Meeting Place 1234", this.state.select_CompanyOffice));

        }
      }
      console.warn("Meeting Office Place", this.state.AppointmentData.meta.appt_meeting_office_place);

    }
    console.warn("Select Meeting Place", this.state.selectMeetingPlace);
    console.warn("Select Meeting Place", this.state.select_CompanyOffice);
  ...
  setAddressAndPostalcode() {
    console.warn("Set Address Postal/////", this.state.selectMeetingPlace);
    if (this.state.selectMeetingPlace === 0) {
      if (this.state.isPage == true) {
        this.setState({ Address: this.state.AppointmentData.location, postalcode: this.state.AppointmentData.postal });
      }
      else {
        this.setState({ Address: this.state.contact_Data.address, postalcode: this.state.contact_Data.postal_code });
      }
  ...
  onSelectedAgentItemsChange = (selectedAgentsItems) => {
    console.warn("Select Meet Agents", selectedAgentsItems);
  ...
  render() {
    ...
    return (
      ...
      <KeyboardAvoidingView style={{ backgroundColor: '#ffffff',flex: 1, flexDirection: 'column',justifyContent: 'center',}} behavior='padding' enabled   keyboardVerticalOffset={10}>
        ...
        <TouchableOpacity activeOpacity={1} style={{ width: '100%'  }}
          ...
          {(PreviousScreen === 'Prospects') ? null :
            ...
            <View>
              ...
              <View style={[ this.state.SelectedContactCompanyName.length === 0 && isSaveClicked ? styles.errorBorder : '' ,{ marginTop: 10, borderRadius: 46 / 2, backgroundColor: Colors.white_shade}]}>
          ...
          <View key={this.state.select_conversation} activeOpacity={1} style={[styles.dropdown_view,this.state.select_conversation === '' && isSaveClicked ? styles.errorBorder : '' , { opacity: (this.state.contact_id ? 1 : 0.8) }]}>
          ...
          <View activeOpacity={1} style={[styles.dropdown_view, this.state.select_meetingType === '' && isSaveClicked ? styles.errorBorder : '' , { opacity: (this.state.contact_id ? 1 : 0.8) }]}>
          ...
          <TouchableOpacity activeOpacity={1} style={[styles.followTimeRectangle,]}
            ...
            <DatePicker
              style={[{
                ...
                opacity: (this.state.contact_id ? 1 : 0.8)
              }]}
          ...
          <Text style={[styles.text_style1]}>Meet Agents:*</Text>
           ...
           {/* this.state.defaultMeetAgent === '' */}
          <View style={[this.state.SelectedMeetAgent === '' && isSaveClicked ? styles.errorBorder : '' ,{ marginTop: 10, borderRadius: 46 / 2, backgroundColor: Colors.white_shade, flexDirection: 'row'  }]}>

            <View style={{ width: widthPercentageToDP(85) }}>
              {console.warn("SELECT AGEWNT", this.state.SelectedMeetAgent)}
              <SectionedMultiSelect
                items={(this.state.ConversationState) ? this.state.MeetAgentData : []}
                 uniqueKey={this.state.isPage ? "name" : "id"}
          ...
          <View activeOpacity={1} style={[styles.dropdown_view, this.state.selectMeetingPlace === '' && isSaveClicked ? styles.errorBorder : '' ,{ opacity: (this.state.contact_id ? 1 : 0.8) }]}>
          ...
          </View>
          {
            ...
            (this.state.selectMeetingPlace == 1 || this.state.selectMeetingPlace == "My Office") ?
          ...
          />
          {/* this.state.selectMeetingPlace === '' && isSaveClicked ? styles.errorBorder : '' , */}
          ...
          <View style={[styles.followTimeRectangle1 ,this.state.note === '' && isSaveClicked ? styles.errorBorder : '' ,]}>
          ...
          <TextInput
            style={[textInput.gray_textInput, { color: '#222222', marginTop: 10, fontSize: 16, fontWeight: '400', }]}
            onChangeText={(value) => this.setState({ note: value })}
            value={this.state.note}
            autoCorrect={false}
            placeholderTextColor={Colors.black_color}
          ...
          {/* <Text style={[styles.text_style1]}>11111111:*</Text>
          ...
          <Text style={[styles.text_style1]}>22222222:*</Text>
          ...
          <Text style={[styles.text_style1]}>33333333:*</Text>
          ...
          <TextInput
            ...
            placeholderTextColor={Colors.black_color}
          />
          <Text style={[styles.text_style1]}>4444444444:*</Text>
          ...
          <TextInput
            ...
            placeholderTextColor={Colors.black_color}
          />
          <Text style={[styles.text_style1]}>55555555:*</Text>
          ...
          <TextInput
            ...
            placeholderTextColor={Colors.black_color}
          />
          <Text style={[styles.text_style1]}>666666666:*</Text>
          ...
          <TextInput
            ...
            placeholderTextColor={Colors.black_color}
          />
          <Text style={[styles.text_style1]}>777777777:*</Text>
          ...
          <TextInput
            ...
            placeholderTextColor={Colors.black_color}
          />
          <Text style={[styles.text_style1]}>88888888:*</Text>
          ...
          <TextInput
            ...
            placeholderTextColor={Colors.black_color}
          />
          <Text style={[styles.text_style1]}>99999999:*</Text>
          ...
          <TextInput
            ...
            placeholderTextColor={Colors.black_color}
          />
          <Text style={[styles.text_style1]}>10000000000:*</Text>

          <TextInput
            style={[textInput.gray_textInput, {borderWidth:1, color: '#222222', marginTop: 10, height: 46, fontSize: 16, fontWeight: '400'}]}
            onChangeText={(value) => this.setState({ postalcode: value })}
            value={this.state.postalcode}
            autoCorrect={false}
            placeholderTextColor={Colors.black_color}
