    ...
    return (
      ...
      <KeyboardAwareScrollView style={styles.main_container} enableResetScrollToCoords={true}>
        ...
        {(this.state.isModalVisible) ?
          ...
          <TouchableOpacity style={{ position: 'absolute', width: '100%', height: '100%', backgroundColor: '#000000', opacity: 0.3 }} activeOpacity={0} onPress={() => { this.setState({ isModalVisible: false }) }}>

            <Modal animationType="fade" transparent={true}>

              <TouchableOpacity style={{ flex: 1, padding: 16, backgroundColor: '#ffffff', marginTop: heightPercentageToDP(50) }} activeOpacity={0} onPress={() => { this.setState({ isModalVisible: false }) }}>

                <View style={styles.dropdown_view, { marginTop: 5 }}>

                  <Text style={styles.text_style}>Add Opportunity</Text>
                  ...
                  {(this.state.selected_Company_opportunity) ?

                    <TouchableOpacity style={{ justifyContent: 'center', alignSelf: 'flex-end', width: '32%', height: 42, marginTop: 20, backgroundColor: Colors.primaryColor, borderRadius: 42 / 2 }}
                      onPress={() => { this.setState({ selected_Company_opportunity: false, isModalVisible: false }, () => { this.add_Contact_Opportunities() }) }}>

                      <Text style={{ color: '#fff', marginLeft: 16, justifyContent: 'center', textAlignVertical: 'center', fontSize: 16, fontFamily: 'Helvetica Neue', fontWeight: '400' }}>Add to List</Text>
