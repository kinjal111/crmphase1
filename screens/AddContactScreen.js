...
export default class AddContactScreen extends React.PureComponent {
  ...
  addContact = async () => {
    ...
    if (isConnected) {
      this.setState({isSavedClick:true})
      const api_token = await AsyncStorage.getItem(Constant.api_token);
      let formData = new FormData();
      ...
      console.log('this.state.select_Contact_Type',this.state.select_Contact_Type);
      console.log('this.state.UserData.Company_id',this.state.UserData.Company_id);
          ...
          .then(responseJson => {
            ...
            if (str.status === true) {
              ...
              if (this.state.set_Main_Contact === 0 && this.state.confirm_sub_Contact === 0) {
                console.warn("String ContactC... Added", str);
                showMessage({
                  message: "",
                ...
                console.warn("String ContactC... Sub - Contact", str);
                showMessage({
                  message: "",
                ...
                console.warn("String ContactC... Main - Contact", str);
                showMessage({
                  message: "",
  ...
  render() {
    ...
    return (
      ...
      <KeyboardAwareScrollView  bounces={false} enableResetScrollToCoords={false}>

        <View style={styles.main_container}>

          <ScrollView style={styles.main_container}  bounces={false} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps='handled' keyboardDismissMode='on-drag' nestedScrollEnabled={true}>
            ...
            <SafeAreaView>
              ...
              <View style={{ marginTop: 10, backgroundColor: Colors.white_color, paddingTop: 2, paddingBottom: 20 }}>
                ...
                <View style={{ paddingStart: 16, paddingEnd: 16 }}>
                  ...
                  <View activeOpacity={1} style={[styles.dropdown_view, this.state.select_Contact_Type === '' && this.state.isSavedClick ? styles.errorBorder : '', { marginTop: 4 }]}>
                  ...
                  <TextInput
                    ...
                    onFocus = { () => this.setState({ SearchDesignationState: false ,searchIndustry:false , SearchCountryState:false })}
                  ...
                  <View style={{ marginTop: 10, borderRadius: 46 / 2, backgroundColor: Colors.white_shade, position: 'relative' }}>
                    <TextInput
                      ...
                      placeholderTextColor={Colors.black_color}
                      onFocus = { () => this.setState({ SearchDesignationState: true ,searchIndustry:false , SearchCountryState:false },()=>this.forceUpdate(),console.warn("SearchUpdate ONFOCUS",this.state.SearchDesignationState))}
                    />
                  ...
                  {
                    console.warn("TEST",this.state.SearchDesignationState),
                    ...
                    <View >
                      <FlatList
                        contentContainerStyle={{
                          marginTop: 6,
                        borderWidth:2,borderColor: Colors.lightGray,borderRadius: 40 / 2
                        }}
                  ...
                  <View style={{ marginTop: 10, borderRadius: 46 / 2, backgroundColor: Colors.white_shade, position: 'relative' }}>
                    <TextInput
                      ...
                      placeholderTextColor={Colors.black_color}
                      onFocus = { () => this.setState({ SearchIndustryState:false,searchDesignation:false ,SearchCountryState:true }) }
...

                  {
                    ...
                    <View style={{height:(this.state.CountryArray.length>8 ?390:null),borderWidth: (this.state.CountryArray.length == 0  ?0:2),
                      marginTop: 6,borderColor: Colors.lightGray,borderRadius: 40 / 2,}}>
                      <FlatList
                        // contentContainerStyle={{}}
                        nestedScrollEnabled={true}
                        keyboardShouldPersistTaps='handled'
                  ...
                  <View style={{ marginTop: 10, borderRadius: 46 / 2, backgroundColor: Colors.white_shade, position: 'relative' }}>
                    <TextInput
                      ...
                      placeholderTextColor={Colors.black_color}
                      onFocus = { () =>  this.setState({ SearchIndustryState:true,searchDesignation:false ,SearchCountryState:false }) }
                    />
                    <View style={{ position: 'absolute', top: 13, right: 13 }}>
...

                  {
                    ...
                    <View style={{height:(this.state.IndustryArray.length>8  ?390:null),  borderWidth: (this.state.IndustryArray.length == 0  ?0:2),
                      borderColor: Colors.lightGray,marginTop: 6,
                      borderRadius: 40 / 2,}}>
                      <FlatList
                        // contentContainerStyle={{}}
